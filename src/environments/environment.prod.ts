export const environment = {
  production: true,
  logging: true,
   api_endpoint: 'https://standard-project-dot-taxi2deal.appspot.com/app/',
  //api_endpoint: 'https://standard-project-dot-taxi2dealin.el.r.appspot.com/app/',
  // googleApiKey: 'AIzaSyDTCQc8JvRvCS5z-AZPv3UpX1HxesohbFs', // prod
  googleApiKey: 'AIzaSyCnBQEmJgRbBsU7CKYCxxP5b_UpC29n-h0', // dev
